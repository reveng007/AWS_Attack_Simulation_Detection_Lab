...
1. AWS S3
    ...
    1. **Access S3 from external AWS account**.
       ...
       - DETECTION 2: _EventCode_ - `S3:PutBucketACL` usage to make a S3 bucket publicly accessible. JSON structure can be found [here](https://github.com/reveng007/AWS_Attack_Simulation_Detection_Lab/blob/main/AWS_json_structures/1.%20PutBucketACL.md).
